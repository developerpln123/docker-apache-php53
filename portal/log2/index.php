...
<body>
	...
	<div id="tables">
		...
		<div id="centerpage">
			...
			while ($r = mysql_fetch_array($result, MYSQL_ASSOC)) {
				...
				?>
					<tr class="gradeA">
						...
						<td align="center"><a href="detail.php?s=peg&bln=<?php echo $parameter;?>&unit=<?php echo $r['kdarea'];?>"><?php echo $r['JML_PEGAWAI'];?></a></td>
						<td align="center">
						<?php
						...
						<td align="center"><a href="detail.php?s=non&bln=<?php echo $parameter;?>&unit=<?php echo $r['kdarea'];?>"><?php echo $r['JML_NON'];?></a></td>
			...
			<br/><br/>
			<a target="_blank" style="float:right;" href="excel1.php?bln=<?php echo $parameter;?>"><img height="32" width="32" title="Export Excel" src="media/images/xls.png"></a>
		</div>
